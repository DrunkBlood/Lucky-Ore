...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   public ChunkManager(ServerWorld worldIn, File worldDirectory, DataFixer p_i51538_3_, TemplateManager p_i51538_4_, Executor p_i51538_5_, ThreadTaskExecutor<Runnable> mainThreadIn, IChunkLightProvider p_i51538_7_, ChunkGenerator<?> generatorIn, IChunkStatusListener p_i51538_9_, Supplier<DimensionSavedDataManager> p_i51538_10_, int p_i51538_11_) {
      super(new File(worldIn.getDimension().getType().getDirectory(worldDirectory), "region"), p_i51538_3_);
      this.templateManager = p_i51538_4_;
      this.field_219270_x = worldIn.getDimension().getType().getDirectory(worldDirectory);
      this.world = worldIn;
      ...
      this.pointOfInterestManager = new PointOfInterestManager(new File(this.field_219270_x, "poi"), p_i51538_3_);
   ...
   private static int func_219215_b(ChunkPos pos, ServerPlayerEntity player, boolean p_219215_2_) {
      ...
      if (p_219215_2_) {
         ...
         i = MathHelper.floor(player.func_226277_ct_() / 16.0D);
         j = MathHelper.floor(player.func_226281_cx_() / 16.0D);
      }
   ...
   private ChunkHolder func_219213_a(long p_219213_1_, int p_219213_3_, @Nullable ChunkHolder p_219213_4_, int p_219213_5_) {
      if (p_219213_5_ > MAX_LOADED_LEVEL && p_219213_3_ > MAX_LOADED_LEVEL) {
         ...
         if (p_219213_3_ <= MAX_LOADED_LEVEL && p_219213_4_ == null) {
            ...
            this.loadedChunks.put(p_219213_1_, p_219213_4_);
   ...
   protected void tick(BooleanSupplier hasMoreTime) {
      ...
      this.pointOfInterestManager.func_219115_a(hasMoreTime);
   ...
   private void scheduleUnloads(BooleanSupplier hasMoreTime) {
      ...
      for(int i = 0; longiterator.hasNext() && (hasMoreTime.getAsBoolean() || i < 200 || this.field_219261_o.size() > 2000); longiterator.remove()) {
         ...
         return completablefuture.thenComposeAsync((p_223180_4_) -> {
            ...
            if (!optional.isPresent()) {
               ...
               if (p_219244_2_ == ChunkStatus.LIGHT) {
                  this.ticketManager.func_219356_a(TicketType.LIGHT, chunkpos, 33 + ChunkStatus.getDistance(ChunkStatus.FEATURES), chunkpos);
               }
               ...
               if (ichunk.getStatus().isAtLeast(p_219244_2_)) {
                  ...
                  if (p_219244_2_ == ChunkStatus.LIGHT) {
                     ...
                     completablefuture1 = p_219244_2_.func_223201_a(this.world, this.templateManager, this.lightManager, (p_223175_2_) -> {
      ...
      return CompletableFuture.supplyAsync(() -> {
         try {
            ...
            if (compoundnbt != null) {
               ...
               if (flag) {
                  IChunk ichunk = ChunkSerializer.func_222656_a(this.world, this.templateManager, this.pointOfInterestManager, p_223172_1_, compoundnbt);
   ...
   private CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_223156_b(ChunkHolder p_223156_1_, ChunkStatus p_223156_2_) {
      ...
      return completablefuture.thenComposeAsync((p_219235_4_) -> {
         return p_219235_4_.map((p_223148_4_) -> {
            try {
               CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> completablefuture1 = p_223156_2_.func_223198_a(this.world, this.generator, this.templateManager, this.lightManager, (p_222954_2_) -> {
               ...
               crashreportcategory.func_71507_a("Location", String.format("%d,%d", chunkpos.x, chunkpos.z));
               crashreportcategory.func_71507_a("Position hash", ChunkPos.asLong(chunkpos.x, chunkpos.z));
               crashreportcategory.func_71507_a("Generator", this.generator);
   ...
   protected void func_219209_c(ChunkPos p_219209_1_) {
      this.mainThread.enqueue(Util.namedRunnable(() -> {
         this.ticketManager.func_219345_b(TicketType.LIGHT, p_219209_1_, 33 + ChunkStatus.getDistance(ChunkStatus.FEATURES), p_219209_1_);
      }, () -> {
   ...
   private boolean func_219229_a(IChunk chunkIn) {
      ...
      if (!chunkIn.isModified()) {
         ...
         try {
            ...
            CompoundNBT compoundnbt1 = ChunkSerializer.func_222645_a(this.world, chunkIn);
